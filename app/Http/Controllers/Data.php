...
class Data extends Controller
{
    public function index(Request $request)
    {
        ...
        $this->validate($request, [
            'specialitate1' => 'required|between:0,10',
            'lib1' => 'required|between:0,1',
            'specialitate2' => 'required|between:0,10',
            'lib2' => 'required|between:0,1',
            'specialitate3' => 'required|between:0,10',
        ...
        $elev = Elev::create([
            ...
            'buget2' => $request->bug2,
            'buget3' => $request->bug3,
            'contract1' => $request->cont1,
            'contract2' => $request->cont2,
            'contract3' => $request->cont3,
            'limba1' => $request->lib1,
            'limba2' => $request->lib2,
            'limba3' => $request->lib3,
