...
$(document).ready(function () {
    ...
    function med_coreg($not1, $not2, $not3, $aptitudini, $med_exam_abs, $est,$mgnas)
    {
    ...
    $('#calc').click(function () {
        ...
        var $mgnas = parseFloat($('#mgnas').val());
        if ($('#specialitate1 :selected').val() != 0) {
            var sp = $('#specialitate1 :selected').val();
            if ( sp == 3 || sp == 4 || sp == 5) {
                $media1 = med_inf(lim_instruire,lim_straina,matem,informatica,med_ex_ab,est,$mgnas);
            }
            if (sp == 7) {
                $media1 = med_inf(lim_instruire,biologia,matem,chimia,med_ex_ab,est,$mgnas);
            }
            if (sp == 6 || sp == 9 || sp == 10) {
                $media1 = med_coreg(lim_instruire,lim_straina,istoria,med_ex_ab,est,$mgnas);
            }
            if (sp == 1 || sp == 2 || sp == 8 ) {
                $media1 = med_inf(lim_instruire,lim_straina,matem,istoria,med_ex_ab,est,$mgnas);
            }
            $('#media1').val($media1);
